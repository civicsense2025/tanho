...
const BUILTIN_PRESETS: Array<{ name: string; data: unknown }> = [
  ...
  { name: "Midnight", data: { accent: "#6d7cff", accent2: "#37d3a6", ink: "#e7e9f5", paper: "#0f1220", font: "grotesk", baseSize: 16, headingScale: 1.1, leading: 1.6, density: 1, radius: "round", shadow: "subtle" } },
  { name: "Harbor", data: { accent: "#2f5d7c", accent2: "#0e8a8a", ink: "#12212b", paper: "#ffffff", font: "geist", baseSize: 16, headingScale: 1.05, leading: 1.6, density: 1, radius: "round", shadow: "subtle" } },
  { name: "Meadow", data: { accent: "#2f6b3f", accent2: "#b0742a", ink: "#161a15", paper: "#fbfdf9", font: "humanist", baseSize: 16, headingScale: 1.1, leading: 1.65, density: 1, radius: "round", shadow: "subtle" } },
];
